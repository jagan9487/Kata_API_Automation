...
Feature: Validate Create Booking API
  ...
  Scenario Outline: User should get expected error message when trying to create a booking using invalid data
    ...
    Examples:
      ...
      | Testfirstname             | morethan19charactersgiven | true        | jagan@test.com | +91-9843945628                | 2026-05-21 | 2026-06-01 | 6      | size must be between 3 and 18       |
      | Testfirstname             | et                        | true        | jagan@test.com | +91-9843945628                | 2026-05-21 | 2026-06-01 | 6      | size must be between 3 and 18       |
      | Testfirstname             | Testlastname              | true        | ubwyu          | +91-9843945628                | 2026-05-21 | 2026-06-01 | 10     | must be a well-formed email address |
      | Testfirstname             | Testlastname              | true        | jagan@test.com | +91-1234567891011121314153432 | 2026-05-21 | 2026-06-01 | 13     | size must be between 11 and 21      |
      | Testfirstname             | Testlastname              | true        | jagan@test.com | +91-9843                      | 2026-05-21 | 2026-06-01 | 14     | size must be between 11 and 21      |
